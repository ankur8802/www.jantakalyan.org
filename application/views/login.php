...
<form action="<?= base_url('Ngo/loginaccount')?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-12">
	<br>
	 <center>  <button class="btn default-btn">Submit</button> </center>
	 <br>
</div>

<div class="col-md-6 text-left">
 <a href="<?= base_url('forgot-password')?>" style="color:#000;text-decoration:underline;"> Forgot Password </a> 
</div>

<div class="col-md-6 text-right">
 <a href="<?= base_url('find-id')?>" style="color:#000;text-decoration:underline;"> Find Your Membership Id </a> 
</div>
