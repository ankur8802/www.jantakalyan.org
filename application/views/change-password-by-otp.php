...
<form action="<?= base_url('Ngo/changepasswordlast')?>" method="post">
...
<div class="col-md-12">
	...
	<p style="visibility:hidden;"><input type="text" class="form-control" name="membership_no" value="<?= $userdata->membership_no?>" required></p>
</div> 
...
<div class="col-md-12">
	<br>
	 <center> <button class="btn default-btn">Update Password</button>  </center>
</div>
