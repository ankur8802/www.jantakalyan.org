...
<form action="<?= base_url('Ngo/checkotp')?>" method="post">
...
<div class="col-md-12">
	...
	<input type="text" class="form-control" name="otp" placeholder="Enter OTP" required style="text-transform: uppercase;">
</div> 
...
<div class="col-md-12">
	<br>
	 <center> <button class="btn default-btn">Submit OTP</button>  </center>
</div>
