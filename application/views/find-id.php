...
<form action="<?= base_url('Ngo/findyourid')?>" method="post">
...
<div class="col-md-12">
	 <center> <h2> Find Id </h2> </center>
	 <br>
</div>

<div class="col-md-12">
	<label>Mobile No.</label>
	<input type="text" class="form-control" name="phone" placeholder="Enter Mobile No...." required style="text-transform: uppercase;">
</div> 
...
<div class="col-md-12">
	<br>
	 <center>  <button class="btn default-btn">Find</button> </center>
	 <br>
</div>
