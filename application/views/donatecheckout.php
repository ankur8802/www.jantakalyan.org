  ...
  <body onload="submitPayuForm()" style="display:none;">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td>Product Info: </td>
          <td colspan="3"><textarea name="productinfo">Sahara Form Fee</textarea></td>
        </tr>
        <tr>
          <td></td>
          <td colspan="3"><input name="surl"  type="hidden" value="<?= base_url('donatesuccess')?>" size="64" /></td>
        </tr>
        <tr>
          <td> </td>
          <td colspan="3"><input name="furl"  type="hidden" value="<?= base_url('donatefailure')?>" size="64" /></td>
        </tr>
